...
typedef Widget LeftBarIndicatorBuilder(BuildContext context, Size size);
...
class Flushbar<T> extends StatefulWidget {
  Flushbar(
      ...
      LeftBarIndicatorBuilder leftBarIndicatorBuilder,
      ...
      : this.title = title,
        ...
        this.leftBarIndicatorBuilder = leftBarIndicatorBuilder,
  ...
  /// If not null, shows a left vertical bar to better indicate the humor of the notification using that builder.
  /// It is not possible to use it with a [Form] and I do not recommend using it with [LinearProgressIndicator]
  final LeftBarIndicatorBuilder leftBarIndicatorBuilder;
...
class _FlushbarState<K extends Object> extends State<Flushbar>
  ...
  Widget _buildLeftBarIndicator() {
    if (widget.leftBarIndicatorColor != null || widget.leftBarIndicatorBuilder != null) {
      return FutureBuilder(
        future: _boxHeightCompleter.future,
        builder: (BuildContext buildContext, AsyncSnapshot<Size> snapshot) {
          if (snapshot.hasData) {
            if (widget.leftBarIndicatorBuilder != null) {
              return widget.leftBarIndicatorBuilder(context, snapshot.data);
            } else {
              return Container(
